...
class ReconciliationTests extends FunSuite with DataFrameSuiteBase {
  ...
  test( "Reconciliation over test data" ) {
    ...
    val layer : DataFrame = utils.populateDataFrameFromCsvWithHeader( "/ndex/policytransaction/writtendeductions/input/layer/layer_PrimaryTestData.csv" )

    val layer_deduction : DataFrame = utils.populateDataFrameFromCsvWithHeader( "/ndex/policytransaction/writtendeductions/input/layer_deduction/layer_deduction_PrimaryTestData.csv" )

    val layer_trust_fund : DataFrame = utils.populateDataFrameFromCsvWithHeader( "/ndex/policytransaction/writtendeductions/input/layer_trust_fund/layer_trust_fund_PrimaryTestData.csv" )

    val line : DataFrame = utils.populateDataFrameFromCsvWithHeader( "/ndex/policytransaction/writtendeductions/input/line/line_PrimaryTestData.csv" )

    val line_risk_code : DataFrame = utils.populateDataFrameFromCsvWithHeader( "/ndex/policytransaction/writtendeductions/input/line_risk_code/line_risk_code_PrimaryTestData.csv" )

    val lookup_deduction_type : DataFrame = utils.populateDataFrameFromCsvWithHeader( "/ndex/policytransaction/writtendeductions/input/lookup_deduction_type/PrimaryTestData.csv" )
