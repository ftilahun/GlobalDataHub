...
I        (IF(layer_trust_fund.est_premium_split_pct IS NOT NULL, layer_trust_fund.est_premium_split_pct, CAST(100.00 AS DECIMAL(5,2))) / 100))) AS DECIMAL(18,6)) AS originalamount,
